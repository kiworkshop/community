...
import static org.kiworkshop.community.content.mjarticle.api.dto.MjArticleDetailResponseDtoTest.getMjArticleDetailResponseDtoFixture;
import static org.kiworkshop.community.content.mjarticle.api.dto.MjArticleResponseDtoTest.getMjArticleResponseDtoFixture;
...
class MjArticleControllerTest {
  ...
  void createMjArticle_ValidInput_ValidOutput() throws Exception {
    // given
    MjArticleRequestDto mjArticleRequestDto = MjArticleRequestDtoTest.getMjArticleRequestDtoFixture();
