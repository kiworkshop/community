package org.kiworkshop.community.content.myanglog.api;
...
import org.kiworkshop.community.content.myanglog.api.dto.MyangPostResponseDtoTest;
import org.kiworkshop.community.content.myanglog.exception.MyangPostNotFoundException;
import org.kiworkshop.community.content.myanglog.service.MyangPostService;
...
class MyangPostControllerTest {
  ...
  void readPost_ValidInput_ValidOutput() throws Exception {
    MyangPostResponseDto myangPostResponseDto = MyangPostResponseDtoTest.getMyangPostResponseFixture();
  ...
  void update_ValidInput_ValidOutput() throws Exception {
    MyangPostRequestDto myangPostRequestDto = MyangPostRequestDtoTest.getMyangPostRequestDtoFixture();
