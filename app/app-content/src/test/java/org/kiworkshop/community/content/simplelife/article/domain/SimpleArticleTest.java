package org.kiworkshop.community.content.simplelife.article.domain;
...
public class SimpleArticleTest {
  public static SimpleArticle getArticleFixture(Long id) throws Exception {
    Set<SimpleTag> simpleTags = SimpleTagTest.getTagsFixture();
  ...
  void update_ValidInput_ValidOutput() {
    // given
    Set<SimpleTag> simpleTags = SimpleTagTest.getTagsFixture(Set.of("tag"));
    Set<SimpleTag> newSimpleTags = SimpleTagTest.getTagsFixture(Set.of("newTag"));
  ...
  void add_ValidInput_ValidOutput() {
    // given
    Set<SimpleTag> tags = SimpleTagTest.getTagsFixture(Set.of("tag"));
