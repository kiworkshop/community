...
=== Read a comment
A `GET` request to read a comment.

operation::/comments/read-a-comment[snippets='http-request,path-parameters,http-response,response-fields']

=== Read comments
A `GET` request to read comments.

operation::/comments/read-comments[snippets='http-request,request-parameters,http-response,response-fields']
