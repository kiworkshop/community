package org.kiworkshop.community.content.jgraphy.service;

import static org.assertj.core.api.BDDAssertions.then;
import static org.assertj.core.api.BDDAssertions.thenThrownBy;
import static org.kiworkshop.community.content.jgraphy.service.JgraphyPostService.JgraphyPostAssembler.toEntity;
...
import org.kiworkshop.community.content.jgraphy.api.dto.JgraphyPostRequestDto;
import org.kiworkshop.community.content.jgraphy.api.dto.JgraphyPostRequestDtoTest;
import org.kiworkshop.community.content.jgraphy.api.dto.JgraphyPostResponseDto;
import org.kiworkshop.community.content.jgraphy.domain.JgraphyPost;
import org.kiworkshop.community.content.jgraphy.domain.JgraphyPostRepository;
...
class JgraphyPostServiceTest {
  ...
  void readJgraphyPostPage_validInput_validOutput() {
    ...
    for (long i = 1; i < 11L; i++) {
      jgraphyPosts.add(JgraphyPostTest.getJgraphyPostFixture(i));
    }
  ...
  void createJgraphyPost_validInput_validOutput() {
    // given
    JgraphyPostRequestDto jgraphyPostRequestDto = JgraphyPostRequestDtoTest.getJgraphyPostRequestDtoFixture();

    JgraphyPost jgraphyPostToSave = JgraphyPostTest.getJgraphyPostFixture();
  ...
  void readJgraphyPost_validInput_validOutput() throws Exception {
    // given
    JgraphyPost jgraphyPost = JgraphyPostTest.getJgraphyPostFixture();
  ...
  void deleteJgraphyPost_validInput_validOutput() {
    JgraphyPost jgraphyPostToDelete = JgraphyPostTest.getJgraphyPostFixture();
  ...
  void findJgrpahyPost_validInput_validOutput() {
    JgraphyPost jgraphyPostToFind = JgraphyPostTest.getJgraphyPostFixture();
