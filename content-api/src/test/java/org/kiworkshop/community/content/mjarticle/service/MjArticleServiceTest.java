...
import static org.kiworkshop.community.content.mjarticle.domain.MjArticleTest.getMjArticleFixture;
...
class MjArticleServiceTest {
  ...
  void createEntityFrom_Request_ValidOutput() {
    // given
    MjArticleRequestDto request = MjArticleRequestDtoTest.getMjArticleRequestDtoFixture();
